...
appendFileSync(resolve(outputDirectory, 'README.md'), '\n## 副本局部组件\n\n交付包已包含预构建的 React 与 Ant Design 浏览器运行时。模型生成的普通 JavaScript 保存在每个副本的 `module.js` 中，由共享运行时直接挂载到副本 DOM，模块没有独立安全沙箱；无需 JSON UI Schema 或按组件注册适配器，也没有逐次 JSX/TSX 编译。健康检查中的 `replicaComponentRuntimeReady` 应为 `true`。\n');
